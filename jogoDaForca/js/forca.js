...
var nomePessoa = ["Samantha", "Sofia", "Ricardo", "Araújo", "José", "André", "Silvia", "Mariana", "Soraia", "Adélia", "Rogério", "Alexandre", "Jonas", "Henrique", "Márcio", "Mário", "Henriqueta", "Marieta", "Armando", "Orlando", "João", "Caio", "Emerson", "Douglas", "Cícero", "Gabriel", "Pedro", "Nathália", "Joana", "Monique", "Eduarda", "Eduardo", "Michael", "Ana", "Severina", "Jorge", "Harry", "Roberto", "Manoela"];
var campoPalavra = [nomeAnimal, UtensiCozinha, ObjCasa, objLimpeza, nomeComidaBebida, nomePessoa];
var abc = "ABCDEFGHIJKLMNOPQRSTUVXZ";
var especial = "AEIOUC"; // letras que podem ter acento
...
function novaPalavra() {
   ...
   var dica = "<b><font color='purple'>Dica:</font> A palavra identifica ";

   switch (campoPalavra.indexOf(vetor)) {
      case 0: dica += "um animal.</b>";
      break;
      case 1: dica += "um utensílio de cozinha.</b>";
      break;
      case 2: dica += "um objeto de casa.</b>";
      break;
      case 3: dica += "um objeto utilizado para limpeza de casa ou roupa.</b>";
      break;
      case 4: dica += "uma comida ou uma bebida.</b>";
      break;
      case 5: dica += "um nome de pessoa.</b>";
   }

   document.getElementById('dica').innerHTML = dica;
   document.getElementById('boneco_forca').style.backgroundPosition = "960px";
}
